...
public class Loading_UrbanEnigma : MonoBehaviour
{
    [SerializeField] private Slider loading_UrbanEnigma;
    [SerializeField] private UnityEvent onFinish_UrbanEnigma;
    ...
    public void TriggerLoading_UrbanEnigma()
    {

        loading_UrbanEnigma.DOValue(1, duration).OnComplete(() =>
        {
            onFinish_UrbanEnigma?.Invoke();
        });
