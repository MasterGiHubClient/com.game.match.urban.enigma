...
public class Cell_UrbanEnigma : MonoBehaviour
{
	[SerializeField] private TMP_Text number_cell_t;
	...
	public void onClick()
	{
		Manager_Game_UrbanEnigma.instance.StartLevel_UrbanEnigma(this.gameObject.transform.GetSiblingIndex());
...
[Serializable]
public class LevelData_UrbanEnigma
{
	public int level = 1;
